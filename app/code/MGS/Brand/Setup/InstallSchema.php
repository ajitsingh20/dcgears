...
class InstallSchema implements InstallSchemaInterface
{
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $table = $installer->getConnection()
            ...
            ->addIndex(
                $installer->getIdxName('mgs_brand_store', ['store_id']),
                ['store_id']
            )
            ->addForeignKey(
                $installer->getFkName('mgs_brand_store', 'brand_id', 'mgs_brand', 'brand_id'),
                'brand_id',
            ...
            ->addForeignKey(
                $installer->getFkName('mgs_brand_store', 'store_id', 'store', 'store_id'),
                'store_id',
